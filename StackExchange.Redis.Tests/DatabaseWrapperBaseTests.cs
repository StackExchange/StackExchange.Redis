...
{
    [TestFixture]
    public sealed class DatabaseWrapperBaseTests
    {
        private Mock<IDatabaseAsync> mock;
        private DatabaseWrapperBase<IDatabaseAsync> wrapper;

        [SetUp]
        public void Initialize()
        {
            mock = new Mock<IDatabaseAsync>();
            wrapper = new DatabaseWrapperBase<IDatabaseAsync>(mock.Object, "prefix:");
        }
