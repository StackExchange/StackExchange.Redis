    ...
    public class Streams : TestBase
    {
        ...
        public void StreamConsumerGroupClaimMessages()
        {
            ...
            using (var conn = Create())
            {
                ...
                var consumer1Messages = db.StreamReadGroup(key, groupName, consumer1, StreamConstants.ReadMinValue, 1);
        ...
        public void StreamConsumerGroupClaimMessagesReturningIds()
        {
            ...
            using (var conn = Create())
            {
                ...
                // Claim the messages for consumer1.
                var messageIds = db.StreamClaimMessagesReturningIds(key,
                                    groupName,
                                    consumer1,
                                    0, // Min message idle time
                                    messageIds: pendingMessages.Select(pm => pm.MessageId).ToArray());
        ...
        public void StreamGroupInfoGet()
        {
            ...
            using (var conn = Create())
            {
                ...
                db.StreamCreateConsumerGroup(key, group1, StreamConstants.ReadMinValue);
                db.StreamCreateConsumerGroup(key, group2, StreamConstants.ReadMinValue);
        ...
        public void StreamGroupConsumerInfoGet()
        {
            ...
            using (var conn = Create())
            {
                ...
                db.StreamCreateConsumerGroup(key, group, StreamConstants.ReadMinValue);
