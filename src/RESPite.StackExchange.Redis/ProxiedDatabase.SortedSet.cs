...
internal sealed partial class ProxiedDatabase
{
    ...
    public Task<RedisValue[]> SortedSetRangeByValueAsync(RedisKey key, RedisValue min, RedisValue max, Exclude exclude, Order order, long skip = 0, long take = -1, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();
    ...
    public RedisValue[] SortedSetRangeByValue(RedisKey key, RedisValue min, RedisValue max, Exclude exclude, Order order, long skip = 0, long take = -1, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();
