...
internal sealed partial class ProxiedDatabase
{
    ...
    public Task<StreamTrimResult> StreamAcknowledgeAndDeleteAsync(RedisKey key, RedisValue groupName, StreamTrimMode trimMode, RedisValue messageId, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();

    public Task<StreamTrimResult[]> StreamAcknowledgeAndDeleteAsync(RedisKey key, RedisValue groupName, StreamTrimMode trimMode, RedisValue[] messageIds, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();
    ...
    public Task<StreamTrimResult[]> StreamDeleteAsync(RedisKey key, RedisValue[] messageIds, StreamTrimMode trimMode, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();
    ...
    public Task<StreamPendingMessageInfo[]> StreamPendingMessagesAsync(RedisKey key, RedisValue groupName, int count, RedisValue consumerName, RedisValue? minId = null, RedisValue? maxId = null, long? idleTime = null, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();
    ...
    public StreamTrimResult StreamAcknowledgeAndDelete(RedisKey key, RedisValue groupName, StreamTrimMode trimMode, RedisValue messageId, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();

    public StreamTrimResult[] StreamAcknowledgeAndDelete(RedisKey key, RedisValue groupName, StreamTrimMode trimMode, RedisValue[] messageIds, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();
    ...
    public StreamTrimResult[] StreamDelete(RedisKey key, RedisValue[] messageIds, StreamTrimMode trimMode, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();
    ...
    public StreamPendingMessageInfo[] StreamPendingMessages(RedisKey key, RedisValue groupName, int count, RedisValue consumerName, RedisValue? minId = null, RedisValue? maxId = null, long? idleTime = null, CommandFlags flags = CommandFlags.None) =>
        throw new NotImplementedException();
