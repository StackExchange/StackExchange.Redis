...
public sealed class RespCommandAttribute(string? command = null) : Attribute
{
    ...
    {
        private const string Prefix = "global::RESPite.RespParsers.";

        public const string Summary = Prefix + nameof(RespParsers.ResponseSummary)
                                             + "." + nameof(RespParsers.ResponseSummary.Parser);
