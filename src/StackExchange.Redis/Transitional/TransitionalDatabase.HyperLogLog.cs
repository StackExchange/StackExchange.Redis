...
namespace StackExchange.Redis
{
    ...
    internal sealed partial class TransitionalDatabase
    {
        ...
        public bool HyperLogLogAdd(RedisKey key, RedisValue value, CommandFlags flags = CommandFlags.None)
            => Wait(_inner.HyperLogLog.AddAsync(key, value, flags));
        ...
        public bool HyperLogLogAdd(RedisKey key, RedisValue[] values, CommandFlags flags = CommandFlags.None)
            => Wait(_inner.HyperLogLog.AddAsync(key, Required(values, nameof(values)), flags));
        ...
        public long HyperLogLogLength(RedisKey key, CommandFlags flags = CommandFlags.None)
            => Wait(_inner.HyperLogLog.LengthAsync(key, flags));
        ...
        public long HyperLogLogLength(RedisKey[] keys, CommandFlags flags = CommandFlags.None)
            => Wait(_inner.HyperLogLog.LengthAsync(Required(keys, nameof(keys)), flags));
        ...
        public void HyperLogLogMerge(RedisKey destination, RedisKey first, RedisKey second, CommandFlags flags = CommandFlags.None)
            => Wait(_inner.HyperLogLog.MergeAsync(destination, [first, second], flags));
        ...
        public void HyperLogLogMerge(RedisKey destination, RedisKey[] sourceKeys, CommandFlags flags = CommandFlags.None)
            => Wait(_inner.HyperLogLog.MergeAsync(destination, Required(sourceKeys, nameof(sourceKeys)), flags));
