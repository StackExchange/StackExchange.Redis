...
#pragma warning restore CS0618
        ...
        internal string GetRespString(PhysicalConnection connection)
        {
            ...
            {
                WriteImpl(in writer);
                var bytes = writer.FlushBlockBuffer();
        ...
        internal void BufferTo(PhysicalConnection physical)
        {
        ...
        internal void BufferTo(PhysicalConnection physical, CommandMap commandMap, byte[]? channelPrefix)
        {
        ...
        internal void BufferHighIntegrityChecksumRequest(PhysicalConnection physical)
        {
