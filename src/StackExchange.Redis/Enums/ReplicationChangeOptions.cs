...
namespace StackExchange.Redis
{
    ...
    public enum ReplicationChangeOptions
    {
        ...
        /// </summary>
        [Obsolete("Starting with Redis version 5, Redis has moved to 'replica' terminology. Please use " + nameof(ReplicateToOtherEndpoints) + " instead, this will be removed in 4.0.", error: true)]
