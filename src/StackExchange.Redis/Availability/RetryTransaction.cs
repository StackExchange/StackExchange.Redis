...
{
    /// <inheritdoc/>
    public RespDatabaseContext Context => new(RetryDatabase.GetContextCore());
    ...
    /// <inheritdoc cref="RetryDatabase.GetContextCore"/>
    RespContext IRespTarget.Context => RetryDatabase.GetContextCore();
