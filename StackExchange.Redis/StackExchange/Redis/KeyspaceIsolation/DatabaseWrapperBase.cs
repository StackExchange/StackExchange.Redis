...
{
    internal class DatabaseWrapperBase<TInner> : RedisWrapperBase<TInner>, IDatabaseAsync where TInner : IDatabaseAsync
    {
        internal DatabaseWrapperBase(TInner inner, RedisKey prefix)
            : base(inner, prefix)
        {
        }
