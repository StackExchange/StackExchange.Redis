namespace StackExchange.Redis
{
    ...
    {
        private readonly static AutoResetEvent _resetEvent = new AutoResetEvent(true);
        ...
        private static Lazy<IEnumerable<IRedisCommandHandler>> lazyCommandHandlers = new Lazy<IEnumerable<IRedisCommandHandler>>(() => GetImplementations<IRedisCommandHandler>());
        ...
        /// <summary>
        /// Drops all configured services and implementations. USE IN TESTS ONLY!
        /// </summary>
        internal static void Reset()
        {
            ...
            {
                Services.Clear();
                lazyCommandHandlers = new Lazy<IEnumerable<IRedisCommandHandler>>(() => GetImplementations<IRedisCommandHandler>());
            }
            finally
            {
                _resetEvent.Set();
