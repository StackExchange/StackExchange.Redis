...
namespace StackExchange.Redis
{
    ...
    public interface IDatabaseAsync : IRedisAsync
    {
        ...
        /// <remarks>https://redis.io/topics/streams-intro</remarks>
        Task<bool> StreamCreateConsumerGroupAsync(RedisKey key, RedisValue groupName, GroupCreateOptions? options = null, CommandFlags flags = CommandFlags.None);
        ...
        /// <remarks>https://redis.io/commands/xpending</remarks>
        Task<StreamPendingMessageInfo[]> StreamPendingMessagesAsync(RedisKey key, RedisValue groupName, int count, RedisValue consumerName, Range? range = null, CommandFlags flags = CommandFlags.None);
        ...
        Task<RedisStreamEntry[]> StreamRangeAsync(RedisKey key, Range? range = null, int? count = null, CommandFlags flags = CommandFlags.None);
        ...
        Task<RedisStreamEntry[]> StreamReadAsync(RedisKey key, ReadOffset readOffset, int? count = null, CommandFlags flags = CommandFlags.None);
        ...
        /// <remarks>https://redis.io/commands/xread</remarks>
        Task<RedisStream[]> StreamReadAsync(StreamReadOffsetPair[] streamOffsetPairs, int? countPerStream = null, CommandFlags flags = CommandFlags.None);
        ...
        Task<RedisStreamEntry[]> StreamReadGroupAsync(RedisKey key, RedisValue groupName, RedisValue consumerName, GroupReadOffset? readOffset = null, int? count = null, CommandFlags flags = CommandFlags.None);
        ...
        /// <remarks>https://redis.io/commands/xreadgroup</remarks>
        Task<RedisStream[]> StreamReadGroupAsync(StreamGroupReadOffsetPair[] streamOffsetPairs, RedisValue groupName, RedisValue consumerName, int? countPerStream = null, CommandFlags flags = CommandFlags.None);
